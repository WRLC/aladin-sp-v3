...
$config = [
     ...
     * reverse proxy).
     */
    'baseurlpath' => $_ENV['SSP_BASEURLPATH'],
     ...
     */
    'technicalcontact_name' => $_ENV['SSP_TECHNICALCONTACT_NAME'],
    'technicalcontact_email' => $_ENV['SSP_TECHNICALCONTACT_EMAIL'],
     ...
     */
    'secretsalt' => $_ENV['SSP_SECRETSALT'],
     ...
     */
    'auth.adminpassword' => $_ENV['SSP_ADMINPASSWORD'],
...
-     * - %stat: if the log entry is intended for statistical purposes, it will print the string 'STAT ' (bear in mind
     ...
     */
    'database.dsn' => $_ENV['SSP_DB_DSN'],

    /*
     * SQL database credentials
     */
    'database.username' => $_ENV['SSP_DB_USERNAME'],
    'database.password' => $_ENV['SSP_DB_PASSWORD'],
    'database.options' => [],

    /*
     * (Optional) Table prefix
     */
    'database.prefix' => 'ssp_',
     ...
     */
    'session.phpsession.cookiename' => 'test',
     ...
     */
    'metadatadir' => $_ENV['SSP_METADATA_DIR'],
